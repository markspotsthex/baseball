...
r.manage_il(s23,{'to':[('Suzuki','Seiya')],'date':'2023-03-24'})
r.manage_il(s23,{'to':[('Montas','Frankie')],'date':'2023-03-24'})

r.add_from_FA(s23,{'add':[('Canha','Mark')],'date':'2023-03-26'})

r.manage_il(s23,{'to':[('Wright','Kyle')],'date':'2023-03-26'})
r.update_roster(s23)
...
r.manage_il(s23,{'from':[('Suzuki','Seiya')]
                  ,'to':[('Fried','Max')]
                  ,'date':'2023-03-30'})
